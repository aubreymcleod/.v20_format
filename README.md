...
The wrapper is a bit of a stop-gap, and probably won't be able to do everything I would like to with this format. I do not believe that Vice supports `basic` instruction injection directly through the command line; there may be a workaround based on loading a tape/disk image as well, but I need to experiment.
